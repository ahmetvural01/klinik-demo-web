...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  { key: "invoices",       icon: "🧾", category: "finans",   label: "Fatura ve Cari Hesap",    permissions: ["invoices:read", "invoices:write", "invoices:delete", "invoices:send"] },
  ...
  { key: "campaigns",      icon: "🎯", category: "yonetim",  label: "Kampanya ve Promosyon",   permissions: ["campaigns:read", "campaigns:write"] },
  { key: "insurance",      icon: "🏥", category: "yonetim",  label: "Sigorta ve Kurumsal",     permissions: ["insurance:read", "insurance:write"] },
  ...
  { key: "notifications",  icon: "🔔", category: "iletisim", label: "Bildirim Tercihleri",     permissions: ["notifications:manage"] },
  ...
  { key: "integrations",   icon: "🔌", category: "sistem",  label: "Entegrasyonlar",          permissions: ["integrations:read", "integrations:write"] },
  { key: "backup",         icon: "💾", category: "sistem",  label: "Yedekleme",               permissions: ["backup:read", "backup:write"] },
...
export const PERMISSION_DETAILS: Record<string, PermissionDetail> = {
  ...
  // ── FATURA ───────────────────────────────────────────────────────────────
  "invoices:read":          { code: "invoices:read",          risk: "dusuk",   title: "Fatura — Görüntüleme",                       description: "Fatura listesini ve cari hesap hareketlerini inceleyebilir." },
  "invoices:write":         { code: "invoices:write",         risk: "orta",    title: "Fatura — Oluşturma ve Düzenleme",            description: "Yeni fatura kesebilir, mevcut faturayı düzenleyebilir." },
  "invoices:delete":        { code: "invoices:delete",        risk: "yuksek",  title: "Fatura — İptal / Silme",                     description: "Faturayı iptal edebilir veya sistemden silebilir. Vergi kaydını etkiler." },
  "invoices:send":          { code: "invoices:send",          risk: "orta",    title: "Fatura — E-posta ile Gönderme",              description: "Faturayı hastanın e-posta adresine otomatik olarak gönderebilir." },
  // ── STOK ─────────────────────────────────────────────────────────────────
  ...
  // ── KAMPANYA ─────────────────────────────────────────────────────────────
  "campaigns:read":         { code: "campaigns:read",         risk: "dusuk",   title: "Kampanya — Görüntüleme",                     description: "Aktif ve geçmiş kampanyaları, indirim kurallarını inceleyebilir." },
  "campaigns:write":        { code: "campaigns:write",        risk: "orta",    title: "Kampanya — Oluşturma ve Düzenleme",          description: "Yeni kampanya oluşturabilir, kampanya koşullarını ve geçerlilik tarihlerini düzenleyebilir." },
  // ── SİGORTA ──────────────────────────────────────────────────────────────
  "insurance:read":         { code: "insurance:read",         risk: "dusuk",   title: "Sigorta ve Kurumsal — Görüntüleme",          description: "Sigorta anlaşmalarını, kurumsal hasta limitlerini ve tahakkuk bilgilerini görebilir." },
  "insurance:write":        { code: "insurance:write",        risk: "orta",    title: "Sigorta ve Kurumsal — Düzenleme",            description: "Sigorta ve kurumsal anlaşma koşullarını düzenleyebilir, hasta sigorta bilgisi girebilir." },
  // ── DENETİM ──────────────────────────────────────────────────────────────
  ...
  // ── BİLDİRİMLER ──────────────────────────────────────────────────────────
  "notifications:manage":   { code: "notifications:manage",   risk: "dusuk",   title: "Bildirimler — Tercih Yönetimi",              description: "Hangi olaylar için bildirim alınacağını ve bildirim kanallarını (e-posta, SMS, uygulama) yapılandırabilir." },
  // ── DESTEK ───────────────────────────────────────────────────────────────
  ...
  // ── ENTEGRASYONLAR ───────────────────────────────────────────────────────
  "integrations:read":      { code: "integrations:read",      risk: "orta",    title: "Entegrasyonlar — Görüntüleme",               description: "Bağlı harici sistemleri (POS, SMS sağlayıcı, e-fatura) ve bağlantı durumlarını görebilir." },
  "integrations:write":     { code: "integrations:write",     risk: "yuksek",  title: "Entegrasyonlar — Yapılandırma",              description: "Harici sistem entegrasyonlarını ekleyebilir, güncelleyebilir veya bağlantıyı kesebilir." },
  // ── YEDEKLEME ────────────────────────────────────────────────────────────
  "backup:read":            { code: "backup:read",            risk: "orta",    title: "Yedekleme — Geçmiş Görüntüleme",             description: "Yedekleme geçmişini, yedek dosyalarını ve zamanlanmış yedekleme durumunu görebilir." },
  "backup:write":           { code: "backup:write",           risk: "yuksek",  title: "Yedekleme — Tetikleme ve Geri Yükleme",      description: "Manuel yedek alabilir veya yedekten geri yükleme başlatabilir. Kritik sistem işlemi." },
  // ── PROFİL ───────────────────────────────────────────────────────────────
