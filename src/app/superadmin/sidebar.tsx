  ...
  return (
    <>
      ...
      {/* Mobil — hamburger ile açılan kayan çekmece (klinik panelindeki
          aynı `toggle-mobile-sidebar` olayını dinler, bkz. components/layout/sidebar.tsx) */}
      {mobileOpen && (
        <div
        ...
        >
          <div className="flex h-dvh max-h-dvh w-[min(86vw,288px)] flex-col overflow-hidden border-r border-slate-200 bg-white shadow-2xl">
            ...
            <SidebarNav visibleGroups={visibleGroups} pathname={pathname} onNavigate={() => setMobileOpen(false)} />
            <div className="border-t border-slate-100 p-3">
              <LogoutButton />
            </div>
          </div>
