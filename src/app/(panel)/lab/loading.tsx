      ...
      <div className="overflow-hidden rounded-xl border bg-white">
        ...
        {Array.from({ length: 8 }).map((_, i) => (
          <div key={i} className="flex items-center gap-4 border-b border-slate-50 px-4 py-3">
            <div className="h-4 w-24 animate-pulse rounded bg-slate-100" style={{ animationDelay: `${i * 30}ms` }} />
            <div className="h-4 flex-1 animate-pulse rounded bg-slate-100" style={{ animationDelay: `${i * 30}ms` }} />
            <div className="h-4 w-20 animate-pulse rounded bg-slate-100" style={{ animationDelay: `${i * 30}ms` }} />
          </div>
        ))}
      </div>
    </section>
